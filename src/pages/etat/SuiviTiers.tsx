...
import { Contact, Search, Plus, FileDown, Filter } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Échéancier et encours clients/fournisseurs</p>
        </div>
          ...
          <div className="max-w-3xl mx-auto w-full space-y-6">
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-100 flex items-start space-x-4">
              <div className="p-3 bg-white rounded-full shadow-sm">
                <Contact size={24} className="text-indigo-500" />
              </div>
              <div>
