...
import { FileText, Search, Plus, FileDown, Filter } from 'lucide-react';

export default function JournauxEtat() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Impression des journaux de saisie par période</p>
        </div>
