...
import { LineChart, Search, Plus, FileDown, Filter } from 'lucide-react';

export default function ComparatifMultiExercices() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Analyse comparative N vs N-1</p>
        </div>
