...
import { BookOpen, Search, Plus, FileDown, Filter } from 'lucide-react';

export default function PlanComptableEtat() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Impression du plan des comptes généraux</p>
        </div>
