...
import { ScrollText, Search, Plus, FileDown, Filter } from 'lucide-react';

export default function JournalTraitement() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Historique des traitements par lots et intégrations</p>
        </div>
